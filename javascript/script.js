...
function updateTimer() {
  const targetDate = new Date("october 10, 2026 22:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '543815836113'; // Número para el primer botón
  const phoneNumber2 = '543815836113'; // Número para el segundo botón
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '543815606826'; // Número para el primer botón
  const recipientNumber2 = '543815606907'; // Número para el segundo botón
